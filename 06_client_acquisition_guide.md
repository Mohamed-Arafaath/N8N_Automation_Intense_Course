...
## 1. The "Anti-Generalist" Strategy
...
## 2. The "Trojan Horse" Offer (Get Your Foot in the Door)
...
### 📧 Email Template: The "Observation" (Warm)
...
### 💬 LinkedIn DM: The "Value First"
> Hey [Name], I noticed [Company] is doing a lot of [Activity, e.g., content marketing].
>
> I built a small tool that automates [Specific Pain, e.g., turning videos into blog posts] using AI.
>
> I'd love to send you a free video showing how it works—might save your team 5-10 hours a week. No pitch, just thought it would be useful. Want me to send the link?

---

## 4. Pricing Your Services (The "Value Ladder")
...
## 5. Where to Find Clients (Right Now)

1.  **Upwork / Freelancer (Search "n8n" or "Make.com")**
    *   *Tip*: Look for jobs asking for "Zapier". Apply and say "I can do this cheaper and better with n8n."
2.  **Apollo.io (Cold Email)**
    *   Filter: "Owner" or "Founder" of companies with 11-50 employees. (Small enough to decide fast, big enough to have money).
3.  **Twitter / X**
    *   Search: "hiring VA", "hate doing data entry", "looking for automation".
4.  **Local Businesses (Google Maps)**
    *   Search "Real Estate Agency [Your City]". Call them. "Do you have an automated system to follow up with leads instantly?"

---

## 🚀 Your 30-Day Action Plan

*   **Week 1**: Build **3 Portfolio Projects** (Use the course material! e.g., The SEO Bot, The Lead Scraper). Record a Loom video of each working.
*   **Week 2**: Optimize your LinkedIn Profile. Headline: "I build AI Agents that save [Niche] 20+ hours/week."
*   **Week 3**: Send **50 Outreach messages** (Email/LinkedIn) per day.
*   **Week 4**: Close your first $1,000 deal.
